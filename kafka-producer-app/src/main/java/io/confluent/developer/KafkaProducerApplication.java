...
public class KafkaProducerApplication {
    ...
    public KafkaProducerApplication(final Producer<String, String> producer,
        ...
        outTopic = topic;
    } // pass the producer instance as a constructor parameter 

    public Future<RecordMetadata> produce(final String message) {
        final String[] parts = message.split("-"); // process string for sending message 
        ...
        final ProducerRecord<String, String> producerRecord = new ProducerRecord<>(outTopic, key, value); //create ProducerRecord
        return producer.send(producerRecord); // send the record to the broker
    }
